...
abstract: >-
  TLDR: how to connect an older interface to a shared information model without pretending that
  the legacy semantics are cleaner than they are. The report contains a deliberately small
...
and an honest list of what stayed unresolved are included in the appendix.
