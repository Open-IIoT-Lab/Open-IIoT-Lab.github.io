...
abstract: >-
  TLDR: a reference architecture for deploying event-driven services next to industrial equipment
  without adopting a vendor-specific stack. The report covers the deployment manifest, the
...
`OIL-TR-2025-02 (2025)` and please tell us where it fails in your plant.
